	...
	<!DOCTYPE html>
		...
		<!--    utk content    -->
									...
									<tr>
										...
										<td style="text-align: center;">
											<form action="" method="POST">
												<input type="hidden" name="Cus_ID" value="<?php echo $row['Cus_ID']; ?>" hidden>
												<input type="hidden" name="Staff_ID" value="<?php echo $Staff_ID; ?>" hidden>
												<button type="submit" formaction="../../ApplicationLayer/ManageAccount/managecustomer.php?AccType=staff&Staff_ID=<?=$Staff_ID?>&action=view&Cus_ID=<?=$row['Cus_ID']?>" class="button">View</button>
												<button type="submit" formaction="../../ApplicationLayer/ManageAccount/managecustomer.php?AccType=staff&Staff_ID=<?=$Staff_ID?>&action=edit&Cus_ID=<?=$row['Cus_ID']?>" class="Ban">Edit</button>												
							...
							?>
									...
									<br>
									<a style="margin-left: 40%;" href="../../ApplicationLayer/ManageAccount/managecustomer.php?AccType=staff&Staff_ID=<?php echo $Staff_ID?>&action=edit&Cus_ID=<?php echo $row['Cus_ID'];?>" class="button">Edit</a>								
									<a href="../../ApplicationLayer/ManageAccount/managecustomer.php?AccType=staff&Staff_ID=<?php echo $Staff_ID?>&action=delete&Cus_ID=<?php echo $row['Cus_ID'];?>" class="Delete">Delete</a>
									<br></br>
									<?php
									}
