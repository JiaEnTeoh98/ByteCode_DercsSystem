...
<?php
    ...
    $data = $req->RviewAllDeliveryQuote();
...
<html>
    ...
    <body>
        ...
        <center>
        <h3 style="margin-left: 1em; margin-top: 1em; text-decoration: underline;">RIDER DELIVERY LIST</h3>
        <br><br>
                ...
                <thead id="ROW1">
                    ...
                    <tr>
                        ...
                        <form action="" method="POST">
                            ...
                            <td><i style="font-size:20px;background-color:#BCBDFD" type="button" onclick="location.href='RiderDeliveryStatus.php?Quotation_ID=<?=$row['Quotation_ID']?>'">Access</i>
