            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control form-control input-lg" name="StaffUName" placeholder="Username" required>
                    </div>
                    <br>
                    <div class="input-group">         
                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock" aria-hidden="true" style="font-size: larger;"></i></span>
                        <input type="password" class="form-control form-control input-lg" name="StaffPass" id="StaffPass" placeholder="Password" required>
                    </div>
