...
<html>
    ...
    <body>
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-4">
                    ...
                    <div class="input-group">         
                        ...
                        <input type="password" class="form-control form-control input-lg" name="RiderPass" id="RiderPass" placeholder="Password" required>
                    </div>
        ...
        <div style="text-align: center; font-size: medium;">
            Don't have an account? <a class="register" href="./RiderRegister.php"><u>Register here</u></a>.
        </div>
    </body>
</html>