...
<html>
    ...
    <script>
        function showPassword() {
            var x = document.getElementById("CustPass");
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-4">
                    ...
                    <div class="input-group">         
                        ...
                        <input type="password" class="form-control form-control input-lg" name="CustPass" id="CustPass" placeholder="Password" required>
                    </div>
