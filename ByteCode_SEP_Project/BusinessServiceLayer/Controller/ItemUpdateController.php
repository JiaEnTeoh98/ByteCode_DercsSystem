    ...
    class ItemUpdateController{
        ...
        function quotationupdate($Quotation_ID){
            ...
            if($quotation->quotationupdate()){
				echo "<script type='text/javascript'>window.location = '../../ApplicationLayer/ManageItemRepairingStatus/managequotation.php?Quotation_ID=".$_POST['Quotation_ID']."';</script>";
			}
        }
